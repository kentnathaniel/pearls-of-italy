  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        sm: ["0.875rem", { lineHeight: "rfs(1.5rem)" }],
        base: ["rfs(1rem)", { lineHeight: "rfs(1.75rem)" }],
        lg: ["rfs(1.125rem)", { lineHeight: "rfs(2rem)" }],
        xl: ["rfs(1.25rem)", { lineHeight: "rfs(2.25rem)" }],
        "2xl": ["rfs(1.5rem)", { lineHeight: "rfs(2.5rem)" }],
        "3xl": ["rfs(1.875rem)", { lineHeight: "rfs(2.75rem)" }],
        "4xl": ["rfs(2.25rem)", { lineHeight: "rfs(3rem)" }],
